...
Meetsourceと申します。法人向けウェブサービスの開発(ECサイト、顧客管理システム、サーバー監視など)を中心とした業務を行なっております。また、音楽講師歴20年超のノウハウを生かした生徒募集に効率的な教室向けウェブ制作業務も承ります。現役講師による経験を即反映させることが可能です。お気軽にお問い合わせ下さい。
